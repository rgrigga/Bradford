...
<div id="myCarousel" class="carousel slide">
	...
	<div class="carousel-inner">
		<div class="item active">
			<img src="assets/img/columbus.jpg">
			<div class="container">
...
<!-- 						<img src="assets/img/glyphicons-halflings.png"> -->
					...
					<p>
						<a class="btn btn-large btn-primary pull-right" href="#">Get a Quote <i class="icon-circle-arrow-right"></i>
						</a>
					</p>
				</div>
			</div>
		...
		<div class="item">
			<img src="assets/img/device-icons2.png">
			<div class="container">
				<div class="carousel-caption">
					<h1>
		...
		<div class="item">
			<img src="assets/img/hometown.jpg">
			<div class="container">
				<div class="carousel-caption">
					<h1>
						Coded with Best Practices in Mind.
					</h1>
					<p class="lead">
...
<div class="container marketing">
	<h2>
		<i class="icon-2x icon-circle-arrow-down"></i>  Mad Features </h2>
	<div class="row">
		<div class="span4">
			<img class="assets/img-circle" data-src="holder.js/140x140">
			<h3>
				Text/Chat/Email
				<!-- <hr> -->
			</h3>
			<p>
				<i class="icon-ok"></i>Connect with individuals or groups.  Group, live chat, or long-term discussion via live, multi-stream twitter dashboard.
			</p>
			<ul>
	...
	<div class="featurette">
		...
		<img class="featurette-image pull-right" src="assets/img/apple-touch-icon-144-precomposed.png">
	...
	<div class="featurette">
		<a href="http://laravel.com">
			<img class="featurette-image pull-left" src="assets/img/laravel-l-slant.png">
		</a>
		<h2 class="featurette-heading">
			Built on Laravel. 
	...
	<div class="featurette">
		<a href="http://twitter.github.io/bootstrap/">
			<img class="featurette-image pull-right" src="assets/img/build-your-brand2.png">
		</a>
		<h2 class="featurette-heading">
			Built for you.
	...
	<footer>
		...
		<p>
			© 2013 Gristech . Bootstrap v2.3.1 . Laraval Four
			 <!-- · -->
<!-- 			<a href="#">Privacy</a>
			·
			<a href="#">Terms</a> -->
<!-- 		<a href='/'><img class="pull-right" src="assets/img/pat_100.png"></a>
