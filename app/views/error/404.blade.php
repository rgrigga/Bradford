...
// foreach (glob("assets/img/404/*.*") as $file){
// 	echo "$file";
// }
...
<h1> :( 404 error</h1>
			<p>
				<!-- I could not get relative URL's to work on this next line: -->
				<img src="http://l4.gristech.com/<?php echo random_pic(); ?>" alt="">
			</p>

			<p>
				Perhaps you would like to go to our <a href="{{{ URL::to('/') }}}">home page</a>?
			</p>
			<p>Or a search, perhaps?</p>
