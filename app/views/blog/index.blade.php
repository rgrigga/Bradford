...
{{-- The above should be moved to the controller, although I like the ability to see it now. A comment would do just as well during development. intentional neglect of refactoring.  -rg --}}
